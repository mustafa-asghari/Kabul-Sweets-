      ...
      try {
        ...
        if (stored) {
          ...
          const appearance = {
            ...
            primaryColor: parsedConfig.appearance?.primaryColor ?? 'kabulGold',
            borderRadius: parsedConfig.appearance?.borderRadius ?? 'lg',
            compact: parsedConfig.appearance?.compact ?? false,
          };

          const isLegacyDefaultTheme =
            appearance.primaryColor === 'blue' &&
            appearance.borderRadius === 'sm' &&
            appearance.colorScheme === 'auto';

          if (isLegacyDefaultTheme) {
            appearance.primaryColor = 'kabulGold';
