    ...
    <section className="max-w-[1200px] mx-auto px-6 pb-20">
      ...
      >
        ...
        <div className="absolute top-8 right-8 flex gap-2">
          <button className="flex h-10 w-10 items-center justify-center rounded-full border border-black/10 bg-white text-gray-500 shadow-sm transition-all hover:-translate-y-0.5 hover:border-black/40 hover:text-black">
